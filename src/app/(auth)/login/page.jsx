            ...
            <div className='p-10 rounded-xl bg-white'>
                ...
                <form className='space-y-4'>
                    <fieldset className="fieldset">
                        ...
                        <input type="text" className="input w-full bg-[#F3F3F3] border-none" placeholder="Enter your email address" />
                    </fieldset>
                    <fieldset className="fieldset">
                        <legend className="fieldset-legend font-semibold text-[18px] text[#403F3F]">Password</legend>
                        <input type="email" className="input w-full bg-[#F3F3F3] border-none" placeholder="Enter your password" />
                    </fieldset>
